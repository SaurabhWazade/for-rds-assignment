...
sh """sed -i 's/( "jdbc:mysql://localhost:3306/test", "root", "root" )/( "jdbc:mysql://database-1.cl2ge2kg8jsb.ap-south-1.rds.amazonaws.com:3306/test", "admin", "ratan1234" )' userRegistration.jsp
